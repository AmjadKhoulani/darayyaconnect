...
export default function Profile() {
    ...
    const { isRefreshing, containerRef, indicatorRef, handlers } = usePullToRefresh(fetchUser);
                ...
                <main className="px-4 py-6 space-y-6">
                    ...
                    <div className="bg-white dark:bg-slate-800 rounded-3xl p-6 border border-slate-200 dark:border-slate-700 shadow-premium relative overflow-hidden animate-fade-in-up">
                        ...
                        <div className="relative z-10 flex flex-col items-center text-center">
                            ...
                            <h2 className="text-xl font-black text-slate-900 dark:text-slate-100 mb-6">{user.name}</h2>
                    ...
                    <div className="space-y-3 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
                        ...
                        <button onClick={() => navigate('/privacy-policy-mobile')} className="w-full bg-white dark:bg-slate-800 p-4 rounded-2xl border border-slate-200 dark:border-slate-700 flex items-center justify-between hover:bg-slate-50 dark:hover:bg-slate-700 transition active:scale-[0.99] shadow-sm">
                            <div className="flex items-center gap-4">
                                <div className="w-10 h-10 rounded-xl bg-emerald-50 dark:bg-emerald-900/20 text-emerald-600 dark:text-emerald-400 flex items-center justify-center border border-emerald-100 dark:border-emerald-800/50">
                                    <Shield size={18} />
                                </div>
                                <span className="font-bold text-slate-700 dark:text-slate-200 text-sm">الخصوصية والأمان</span>
                            </div>
                            <div className="bg-slate-50 dark:bg-slate-900 p-2 rounded-lg">
                                <ChevronLeft size={16} className="text-slate-400 dark:text-slate-500" />
                            </div>
                        </button>
                    </div>
