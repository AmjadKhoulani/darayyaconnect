...
export default function StrategicModelsWidget() {
    ...
    const models = [
        ...
        },
        {
            ...
            details: {
                problem:
                    'جزيرة صغيرة بلا موارد مياه طبيعية وتعتمد كلياً على الاستيراد من دول مجاورة (تهديد استراتيجي).',
                solution:
                    'تجميع مياه الأمطار من 67% من مساحة الدولة، وإعادة تكرير مياه الصرف الصحي بتقنيات متطورة لتصبح صالحة للشرب.',
        ...
        },
        {
            ...
            details: {
                problem:
                    'ازدياد أعداد السيارات والتلوث والضجيج في وسط المدينة.',
                solution:
                    'تصميم "الموجة الخضراء": ضبط إشارات المرور لتكون خضراء دائماً لراكبي الدراجات بسرعة 20 كم/سا، وبناء جسور خاصة بهم.',
                ...
                <div className="divide-y divide-slate-50">
                    {models.map((model, idx) => (
                        <button
                            ...
                            className="group flex w-full items-start gap-3 p-3 text-right transition-colors hover:bg-slate-50"
                        >
                            <span className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-slate-100 text-xl transition-transform group-hover:scale-110">
                                {model.country}
                            </span>
                            <div className="min-w-0 flex-1">
                                <h3 className="mb-1 truncate text-xs font-bold text-slate-800 transition-colors group-hover:text-emerald-600">
                                    {model.city}
                                </h3>
                            ...
                            <span
                                className={`rounded px-1.5 py-0.5 text-[9px] font-bold ${model.color}`}
                            >
                                {model.tag}
                            </span>
                        </button>
